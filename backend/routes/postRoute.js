...
import express from "express";
import { createPost, deletePost, fetchTwitterPosts, getPostById, getPostsByHashtag, getPostsByUser, initiateTwitterPost, twitterPostCallback, updatePost, selectPosts } from "../controllers/postController.js";
import { authMiddleware } from "../middleware/authMiddleware.js";
...
// POST /api/posts/select - Select and store posts
router.post("/select", authMiddleware, selectPosts);
